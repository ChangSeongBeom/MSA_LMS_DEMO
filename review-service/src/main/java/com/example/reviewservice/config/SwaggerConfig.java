...
public class SwaggerConfig {
    private static final String API_NAME = "리뷰서비스(별점,댓글관리)";
    private static final String API_VERSION = "0.0.1";
    private static final String API_DESCRIPTION = "리뷰서비스";
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.reviewservice"))
